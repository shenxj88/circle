...
__DEFINE__(1640063656232, function(require, module, exports) {
...
}, function(modId) {var map = {"./cloudbase":1640063656233,"./const/symbol":1640063656239}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640063656233, function(require, module, exports) {
...
}, function(modId) { var map = {"./functions":1640063656234,"./auth":1640063656244,"./wx":1640063656245,"./storage":1640063656246,"./utils/dbRequest":1640063656247,"./log":1640063656248,"./const/code":1640063656238,"./utils/utils":1640063656237}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640063656234, function(require, module, exports) {
...
}, function(modId) { var map = {"../utils/httpRequest":1640063656235,"../utils/utils":1640063656237,"../const/code":1640063656238}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640063656235, function(require, module, exports) {
...
}, function(modId) { var map = {"./tracing":1640063656236,"./utils":1640063656237,"../const/code":1640063656238,"../const/symbol":1640063656239,"../cloudbase":1640063656233,"./request":1640063656240,"./requestHook":1640063656241,"./getWxCloudApiToken":1640063656242,"../../package.json":1640063656243}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640063656236, function(require, module, exports) {
...
__DEFINE__(1640063656237, function(require, module, exports) {
...
__DEFINE__(1640063656238, function(require, module, exports) {
...
__DEFINE__(1640063656239, function(require, module, exports) {

Object.defineProperty(exports, "__esModule", { value: true });
exports.SYMBOL_CURRENT_ENV = Symbol.for("SYMBOL_CURRENT_ENV");

}, function(modId) { var map = {}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640063656240, function(require, module, exports) {
...
}, function(modId) { var map = {"request":1640063656240,"./utils":1640063656237}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640063656241, function(require, module, exports) {
...
__DEFINE__(1640063656242, function(require, module, exports) {
...
__DEFINE__(1640063656243, function(require, module, exports) {
module.exports = {
  "_from": "@cloudbase/node-sdk@2.0.0-beta.5",
  "_id": "@cloudbase/node-sdk@2.0.0-beta.5",
  "_inBundle": false,
  "_integrity": "sha1-xnRT54mlvmhZ4WjjCmvg/HBVTMY=",
  "_location": "/@cloudbase/node-sdk",
  "_phantomChildren": {},
  "_requested": {
    "type": "version",
    "registry": true,
    "raw": "@cloudbase/node-sdk@2.0.0-beta.5",
    "name": "@cloudbase/node-sdk",
    "escapedName": "@cloudbase%2fnode-sdk",
    "scope": "@cloudbase",
    "rawSpec": "2.0.0-beta.5",
    "saveSpec": null,
    "fetchSpec": "2.0.0-beta.5"
  },
  "_requiredBy": [
    "/wx-server-sdk"
  ],
  "_resolved": "https://registry.npm.taobao.org/@cloudbase/node-sdk/download/@cloudbase/node-sdk-2.0.0-beta.5.tgz",
  "_shasum": "c67453e789a5be6859e168e30a6be0fc70554cc6",
  "_spec": "@cloudbase/node-sdk@2.0.0-beta.5",
  "_where": "/Users/zcf2015/WeChatProjects/circle2/cloudfunctions/login/node_modules/wx-server-sdk",
  "author": {
    "name": "lukejyhuang"
  },
  "bugs": {
...
__DEFINE__(1640063656244, function(require, module, exports) {
...
}, function(modId) { var map = {"../utils/utils":1640063656237,"../const/code":1640063656238,"../cloudbase":1640063656233,"../const/symbol":1640063656239}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640063656245, function(require, module, exports) {
...
__DEFINE__(1640063656246, function(require, module, exports) {
...
__DEFINE__(1640063656247, function(require, module, exports) {
...
}, function(modId) { var map = {"./httpRequest":1640063656235}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1640063656248, function(require, module, exports) {
...
}, function(modId) { var map = {"../utils/utils":1640063656237,"../const/code":1640063656238}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1640063656232);
})()
//miniprogram-npm-outsideDeps=["tcb-admin-node","@cloudbase/database","@cloudbase/signature-nodejs","url","http","jsonwebtoken","request","fs","xml2js"]
